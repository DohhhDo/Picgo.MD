...
def test_adapter_registration():
    ...
    # 验证新增的适配器
    new_adapters = [MdAdapterType.COS, MdAdapterType.Qiniu, MdAdapterType.S3, MdAdapterType.GitHub]
...
def test_adapter_url_generation():
    ...
    # GitHub适配器
    from imarkdown.adapter.github_adapter import GitHubAdapter
    gh_adapter = GitHubAdapter(token="test", owner="user", repo="repo", storage_path_prefix="img")
