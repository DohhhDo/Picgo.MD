...
from PyQt6.QtCore import Qt, QTimer, QSize, pyqtSignal, QSettings, QRect, QPoint
...
class ControlPanel(QWidget):
    ...
    def create_quality_column(self):
        ...
        # 标题
        title = QLabel("图片")
        title.setStyleSheet("font-size: 14px; font-weight: bold; color: #333; font-family: 'Microsoft YaHei';")
    ...
    def create_preset_grid(self):
        ...
        # 标题
        title = QLabel("预设")
        title.setStyleSheet("font-size: 14px; font-weight: bold; color: #333; margin-bottom: 8px; font-family: 'Microsoft YaHei';")
        layout.addWidget(title)
    ...
    def set_progress(self, value):
        ...
        self.progress_indicator.setGeometry(
            0, 
            max_height - progress_height,  # 从底部向上填充
            20, 
            progress_height
        )
